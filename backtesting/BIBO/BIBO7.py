...
def simulate_market(start, end):
    ...
    return trade_log, capital, max_drawdown_pct


def save_trades_to_csv(trades, final_capital, max_drawdown_pct, filename):
    if not trades:
...
if __name__ == "__main__":
    ...
    trades, final_capital, max_dd = simulate_market(start_date, end_date)
